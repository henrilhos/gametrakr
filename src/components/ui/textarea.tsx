...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, label, state, ...props }, ref) => {
    return (
      <div className="relative w-full">
        <textarea
          className={twMerge(
            "peer h-full w-full rounded-2xl border-4 border-neutral-500 border-t-transparent bg-transparent px-4 py-2.5 text-lg text-black shadow-none outline outline-0 dark:border-slate-700 dark:border-t-transparent dark:text-white",
        ...
        <label
          className={twMerge(
            "pointer-events-none absolute -top-1.5 left-0 flex h-full w-full select-none !overflow-visible truncate text-sm font-normal leading-tight text-neutral-800 dark:text-slate-300",

            "before:content[' '] before:pointer-events-none before:mr-1 before:mt-[6px] before:box-border before:block before:h-4 before:w-5 before:rounded-tl-2xl before:border-l-4 before:border-t-4 before:border-neutral-500 dark:before:border-slate-700",

            "after:content[' '] after:pointer-events-none after:ml-1 after:mt-[6px] after:box-border after:block after:h-4 after:w-5 after:flex-grow after:rounded-tr-2xl after:border-r-4 after:border-t-4 after:border-neutral-500 dark:after:border-slate-700",
