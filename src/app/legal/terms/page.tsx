export default function Page() {
  return (
    <div>
      ...
      <p>Updated at 2023-11-10</p>

      <h2>General Terms</h2>

      <p>
        By accessing and placing an order with gametrakr, you confirm that you
      ...
      <p>
        Under no circumstances shall gametrakr team be liable for any direct,
        ...
        inability to use, the materials on this site, even if gametrakr team or
      ...
      <p>
        gametrakr will not be responsible for any outcome that may occur during
      ...
      <h2>License</h2>
      <p>
        gametrakr grants you a revocable, non-exclusive, non-transferable,
        limited license to download, install and use the website/app strictly in
        accordance with the terms of this Agreement.
      </p>
      <p>
        These Terms & Conditions are a contract between you and gametrakr
        (referred to in these Terms & Conditions as &quot;gametrakr&quot;,
        &quot;us&quot;, &quot;we&quot; or &quot;our&quot;), the provider of the
        gametrakr website and the services accessible from the gametrakr website
      ...
      <p>
        ...
        agree to these Terms & Conditions, please do not use the gametrakr
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            ...
            “our,” it refers to gametrakr, that is responsible for your
            information under this Terms & Conditions.
          </li>
          <li>
            <b>Country:</b> where gametrakr or the owners/founders of gametrakr
            are based, in this case is Brazil.
          </li>
          <li>
            <b>Device:</b> any internet connected device such as a phone,
            tablet, computer or any other device that can be used to visit
            gametrakr and use the services.
          </li>
          <li>
            <b>Service:</b> refers to the service provided by gametrakr as
          ...
          <li>
            <b>Website:</b> gametrakr&apos;s site, which can be accessed via
            this URL:{" "}
            <a href="https://gametra.kr" target="_blank">
              https://gametra.kr
            </a>
            .
          </li>
          <li>
            <b>You:</b> a person or entity that is registered with gametrakr to
            use the Services.
          </li>
        </ul>
      </p>
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            ...
            notice of copyright or trademark) of gametrakr or its affiliates,
      ...
      <p>
        Thanks for shopping at gametrakr. We appreciate the fact that you like
      ...
      <p>
        ...
        apply to transactions at gametrakr. We’ll be as brief as our attorneys
        will allow. The main thing to remember is that by placing an order or
        making a purchase at gametrakr, you agree to the terms along with
        gametrakr&apos;s Privacy Policy.
      </p>
      <p>
      ...
      <p>
        ...
        (collectively, &quot;Suggestions&quot;) provided by you to gametrakr
        with respect to the website/app shall remain the sole and exclusive
        property of gametrakr.
      </p>
      <p>
        gametrakr shall be free to use, copy, modify, publish, or redistribute
      ...
      <p>
        ...
        contain links to other websites not operated or controlled by gametrakr.
      ...
      <h2>Cookies</h2>
      <p>
        gametrakr uses &quot;Cookies&quot; to identify the areas of our website
      ...
      <p>
        You acknowledge and agree that gametrakr may stop (permanently or
        ...
        specifically inform gametrakr when you stop using the Service. You
        acknowledge and agree that if gametrakr disables access to your account,
      ...
      <p>
        gametrakr reserves the right to modify, suspend or discontinue,
      ...
      <p>
        gametrakr may from time to time provide enhancements or improvements to
      ...
      <p>
        ...
        the website/app. You agree that gametrakr has no obligation to (i)
      ...
      <p>
        You acknowledge and agree that gametrakr shall not be responsible for
        ...
        or any other aspect thereof. gametrakr does not assume and shall not
      ...
      <p>
        gametrakr may, in its sole discretion, at any time and for any or no
      ...
      <p>
        ...
        gametrakr, in the event that you fail to comply with any provision of
      ...
      <p>
        Termination of this Agreement will not limit any of gametrakr&apos;s
      ...
      <p>
        You agree to indemnify and hold gametrakr and its parents, subsidiaries,
      ...
      <p>
        ...
        kind. To the maximum extent permitted under applicable law, gametrakr,
        ...
        limitation to the foregoing, gametrakr provides no warranty or
      ...
      <p>
        Without limiting the foregoing, neither gametrakr nor any
        gametrakr&apos;s provider makes any representation or warranty of any
        ...
        behalf of gametrakr are free of viruses, scripts, trojan horses, worms,
      ...
      <p>
        ...
        of gametrakr and any of its suppliers under any provision of this
      ...
      <p>
        ...
        gametrakr or its suppliers be liable for any special, incidental,
        ...
        of this Agreement), even if gametrakr or any supplier has been advised
      ...
      <p>
        ...
        notices published by gametrakr on the Services, shall constitute the
        entire agreement between you and gametrakr concerning the Services. If
        ...
        any other term, and gametrakr&apos;s failure to assert any right or
        provision under this Agreement shall not constitute a waiver of such
        right or provision. YOU AND gametrakr AGREE THAT ANY CAUSE OF ACTION
      ...
      <p>
        gametrakr reserves the right, at its sole discretion, to modify or
      ...
      <p>
        The Agreement constitutes the entire agreement between you and gametrakr
        regarding your use of the website/app and supersedes all prior and
        contemporaneous written or oral agreements between you and gametrakr.
      </p>
      <p>
        You may be subject to additional terms and conditions that apply when
        you use or purchase other gametrakr&apos;s services, which gametrakr
      ...
      <p>
        ...
        thereof), are owned by gametrakr, its licensors or other providers of
        ...
        without the express prior written permission of gametrakr, unless and
      ...
      <p>
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR gametrakr&apos;s INTELLECTUAL
        PROPERTY RIGHTS. The term “dispute” means any dispute, action, or other
        controversy between you and gametrakr concerning the Services or this
      ...
      <p>
        In the event of a dispute, you or gametrakr must give the other a Notice
        ...
        <a href="mailto:hello@gametra.kr">hello@gametra.kr</a>. gametrakr will
        send any Notice of Dispute to you by mail to your address if we have it,
        or otherwise to your email address. You and gametrakr will attempt to
        ...
        or gametrakr may commence arbitration.
      </p>

      <h2>Binding Arbitration</h2>
      <p>
        If you and gametrakr don’t resolve any dispute by informal negotiation,
      ...
      <p>
        ...
        and will become the sole property of gametrakr without any compensation
        or credit to you whatsoever. gametrakr and its affiliates shall have no
      ...
      <h2>Promotions</h2>
      <p>
        gametrakr may, from time to time, include contests, promotions,
      ...
      <p>
        ...
        of gametrakr. gametrakr will be entitled to injunctive or other
        equitable relief (without the obligations of posting any bond or surety)
        in the event of any breach or anticipatory breach by you. gametrakr
        operates and controls the gametrakr Service from its offices in . The
        ...
        choose to access the gametrakr Service from other locations do so on
        ...
        & Conditions (which include and incorporate the gametrakr Privacy
        Policy) contains the entire understanding, and supersedes all prior
        understandings, between you and gametrakr concerning its subject matter,
      ...
      <h2>Disclaimer</h2>
      <p>
        gametrakr is not responsible for any content, code or any other
        imprecision.
      </p>
      <p>gametrakr does not provide warranties or guarantees.</p>
      <p>
        In no event shall gametrakr be liable for any special, direct, indirect,
      ...
      <p>
        The gametrakr Service and its contents are provided &quot;as is&quot;
        and &quot;as available&quot; without any warranty or representations of
        any kind, whether express or implied. gametrakr is a distributor and not
        a publisher of the content supplied by third parties; as such, gametrakr
        ...
        accessible via the gametrakr Service. Without limiting the foregoing,
        gametrakr specifically disclaims all warranties and representations in
        any content transmitted on or in connection with the gametrakr Service
        or on sites that may appear as links on the gametrakr Service, or in the
        products provided as a part of, or otherwise in connection with, the
        gametrakr Service, including without limitation any warranties of
        merchantability, fitness for a particular purpose or non-infringement of
        third party rights. No oral advice or written information given by
        gametrakr or any of its affiliates, employees, officers, directors,
        ...
        foregoing, gametrakr does not warrant that the gametrakr Service will be
      ...
      <p>
        ...
        <ul>
          <li>
            Via email: <a href="mailto:hello@gametra.kr">hello@gametra.kr</a>
          </li>
        </ul>
      </p>
    </div>
