export default function Page() {
  return (
    <div>
      ...
      <p>
        gametrakr (“we,” “our,” or “us”) is committed to protecting your
        privacy. This Privacy Policy explains how your personal information is
        collected, used, and disclosed by gametrakr.
      </p>
      ...
      <p>
        ...
        gametrakr. By accessing or using our Service, you signify that you have
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            ...
            signs up to use the gametrakr Service to manage the relationships
          ...
          <li>
            ...
            gametrakr or are under contract to perform a service on behalf of
            one of the parties.
          </li>
          <li>
      ...
      <h2>When Does gametrakr Use End User Information From Third Parties?</h2>
      <p>
        gametrakr will collect End User Data necessary to provide the gametrakr
      ...
      <h2>When Does gametrakr Use Customer Information From Third Parties?</h2>
      <p>
        ...
        in becoming a gametrakr customer, we receive information from a third
        party that provides automated fraud detection services to gametrakr. We
      ...
      <p>
        gametrakr will collect personal information that you submit to us. We
      ...
      <p>
        We keep your information only so long as we need it to provide gametrakr
      ...
      <p>
        ...
        any information you transmit to gametrakr or guarantee that your
      ...
      <p>
        gametrakr is incorporated in Brazil. Information collected via our
      ...
      <h2>
        Is the Information Collected Through the gametrakr Service Secure?
      </h2>
      <p>
      ...
      <p>
        ...
        gametrakr collects depend on your relationship with gametrakr. Personnel
      ...
      <p>
        ...
        the assets of gametrakr or any of its Corporate Affiliates (as defined
        herein), or that portion of gametrakr or any of its Corporate Affiliates
      ...
      <p>
        ...
        control with gametrakr, whether by ownership or otherwise. Any
      ...
      <h2>Governing Law</h2>
      <p>
        This Privacy Policy is governed by the laws of Brazil without regard to
      ...
      <p>
        The laws of Brazil, excluding its conflicts of law rules, shall govern
      ...
      <p>
        By using gametrakr or contacting us directly, you signify your
      ...
      <p>
        ...
        or making a purchase, you hereby consent to our Privacy Policy and agree
        to its terms.
      </p>
      ...
      <p>
        ...
        thing to do. At gametrakr we strongly believe that your data privacy is
      ...
      <p>
        ...
        requirements of GDPR. gametrakr processes or stores all personal data in
