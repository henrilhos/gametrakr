...
const getRatingStyle = (
  ...
  switch (true) {
    case rating < 3:
      return representation === "text" ? "text-red-500" : "bg-red-500";
    case rating < 5:
      return representation === "text" ? "text-orange-500" : "bg-orange-500";
    case rating < 7:
      return representation === "text" ? "text-yellow-500" : "bg-yellow-500";
    case rating < 9:
      return representation === "text" ? "text-green-500" : "bg-green-500";
    case rating <= 10:
      return representation === "text" ? "text-teal-500" : "bg-teal-500";
    default:
      return representation === "text" ? "text-white" : "bg-white";
  }
};
      ...
      <div className="flex gap-0.5 pt-6">
        {Array.from({ length: 10 }).map((_, i) => (
          <div
            key={i}
            className={cn(
              "h-2 w-4 first:rounded-s last:rounded-e",
