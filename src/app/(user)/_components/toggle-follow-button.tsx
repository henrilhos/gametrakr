...
export default function ToggleFollowButton({ userId, isFollowing }: Props) {
    ...
    <button
      ...
      className={cn(
        ...
        isFollowing
          ...
          : "before:content-['Follow'] dark:hover:inner-border-white",
      )}
    />
  );
}
